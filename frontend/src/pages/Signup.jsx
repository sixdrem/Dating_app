  ...
  return (
    <div className="flex justify-center items-center min-h-[70vh]">
      <div className="bg-white shadow-lg rounded-3xl p-8 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent select-none">Create an Account</h2>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? <span className="loader border-2 border-t-2 border-primary rounded-full w-5 h-5 animate-spin"></span> : 'Sign Up'}
          </button>
        </form>
